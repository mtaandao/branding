jQuery(document).ready(function( $ ) {
	...
	if ( $body.is( '.branch-4-3' ) ) {
		...
		// Move messages
		$messages = $( '.wrap > .updated, .wrap > .error, .wrap > .notice, #mnbody-content > .updated, #mnbody-content > .error, #mnbody-content > .notice, #mnbody-content > .update-nag' );
	...
	if ( $body.is( '.edit-tags-php.branch-4-3' ) ) {
		// Move elements on Tags/Category pages
		$( '.wrap > h1, .wrap > #ajax-response, .wrap > .search-form, .wrap > br, .wrap > .updated, .wrap > .error, .wrap > .notice, #mnbody-content > .updated, #mnbody-content > .error, #mnbody-content > .notice' ).prependTo( '#col-right .col-wrap' );
	}
