...
Mtaandao options framework which uses the [Mtaandao Settings API](http://codex.wordpress.org/Settings_API "Mtaandao Settings API"), Custom Error/Validation Handling, Custom Field/Validation Types, and import/export functionality.
...
## Demo Your Products ##
We help you create a seamless user experience for your users to demo your Mtaandao products.  Not only that, we help you make sure they’re engaged, turning them into a potential customer.  Visit [mndemo.io/](http://mndemo.io/)
...
Hot off the press, our Redux Converter plugin. It takes your SMOF instance, and allows you to try out Redux without any fear. It also spits out valid PHP source for you if you want to migrate complete with data migration! Give it a try today. It will be in the Mtaandao.org repo shortly.  ;)
...
ReduxFramework has just released to the Mtaandao Plugins directory. Please spread the word, tweet, and (most importantly) post reviews on http://wordpress.org/plugins/redux-framework/. 
...
* Uses the [Mtaandao Settings API](http://codex.wordpress.org/Settings_API "Mtaandao Settings API")
