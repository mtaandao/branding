    ...
    if ( ! class_exists( 'Redux_Framework_sample_config' ) ) {
        ...
        class Redux_Framework_sample_config {
            ...
            function compiler_action( $options, $css, $changed_values ) {
              ...
              if( $mn_filesystem ) {
                $mn_filesystem->put_contents(
                    $filename,
                    $css,
                    FS_CHMOD_FILE // predefined mode settings for mn files
                );
              }
             */
            }
            ...
            public function setSections() {
                ...
                <div id="current-theme" class="<?php echo esc_attr( $class ); ?>">
                    <?php if ( $screenshot ) : ?>
                        <?php if ( current_user_can( 'edit_theme_options' ) ) : ?>
                            <a href="<?php echo mn_customize_url(); ?>" class="load-customize hide-if-no-customize"
                ...
                if ( file_exists( dirname( __FILE__ ) . '/info-html.html' ) ) {
                    Redux_Functions::initmnFilesystem();

                    global $mn_filesystem;

                    $sampleHTML = $mn_filesystem->get_contents( dirname( __FILE__ ) . '/info-html.html' );
                }
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'subtitle' => __( 'Upload any media using the Mtaandao native uploader', 'redux-framework-demo' ),
                            'hint'     => array(
                                //'title'     => '',
                        ...
                        array(
                            ...
                            'subtitle' => __( 'Create a new Gallery by selecting existing or uploading new images using the Mtaandao native uploader', 'redux-framework-demo' ),
                ...
                $this->sections[] = array(
                    ...
                    */
                        array(
                            ...
                            'subtitle' => __( 'You can use the following shortcodes in your footer text: [mn-url] [site-url] [theme-url] [login-url] [logout-url] [site-title] [site-tagline] [current-year]', 'redux-framework-demo' ),
                ...
                $this->sections[] = array(
                    ...
                    'fields'  => array(
                        ...
                        array(
                            ...
                            'subtitle' => __( 'HTML Allowed (mn_kses)', 'redux-framework-demo' ),
                            'desc'     => __( 'This is the description field, again good for additional info.', 'redux-framework-demo' ),
                            'validate' => 'html', //see http://codex.wordpress.org/Function_Reference/mn_kses_post
                        ...
                        array(
                            ...
                            'subtitle'     => __( 'Custom HTML Allowed (mn_kses)', 'redux-framework-demo' ),
                            'desc'         => __( 'This is the description field, again good for additional info.', 'redux-framework-demo' ),
                            'validate'     => 'html_custom',
                            'default'      => '<p>Some HTML is allowed in here.</p>',
                            'allowed_html' => array( '' ) //see http://codex.wordpress.org/Function_Reference/mn_kses
                        ),
                        array(
                            'id'       => 'opt-textarea-js',
                            'type'     => 'textarea',
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            'id'   => 'opt-info',
                            'type' => 'info',
                            'desc' => __( 'You can easily add a variety of data from Mtaandao.', 'redux-framework-demo' ),
                        ),
                        array(
