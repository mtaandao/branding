    ...
    if ( ! class_exists( 'ReduxFramework_extension_customizer' ) ) {
        ...
        class ReduxFramework_extension_customizer {
            ...
            public function __construct( $parent ) {
                //add_action('mn_head', array( $this, '_enqueue_new' ));

                global $pagenow;
                if ( ( $pagenow !== "customize.php" && $pagenow !== "admin-ajax.php" && ! isset( $GLOBALS['mn_customize'] ) ) ) {
                    return;
                }
                ...
                if ( isset( $_POST['customized'] ) ) {
                    ...
                    add_action( 'mn_head', array( $this, 'customize_preview_init' ) );
                }


                //add_action( 'mn_enqueue_scripts', array( &$this, '_enqueue_previewer_css' ) ); // Enqueue previewer css
                //add_action( 'mn_enqueue_scripts', array( &$this, '_enqueue_previewer_js' ) ); // Enqueue previewer javascript
                //add_action( "mn_footer", array( $this, '_enqueue_new' ), 100 );
                //$this->_enqueue_new();
            }
            ...
            public function _enqueue_new() {
                ...
                /*
                  mn_enqueue_script('redux-extension-customizer-codemirror-js', $this->_extension_url . 'new/codemirror.min.js');
                  mn_enqueue_script('redux-extension-customizer-color-js', $this->_extension_url . 'new/colors-control.js');
                  mn_enqueue_script('redux-extension-customizer-controls-js', $this->_extension_url . 'new/customizer-control.js');
                  mn_enqueue_script('redux-extension-customizer-fonts-js', $this->_extension_url . 'new/fonts-customizer-admin.js');
                  mn_enqueue_script('redux-extension-customizer-header-js', $this->_extension_url . 'new/header-control.js');
                  mn_enqueue_script('redux-extension-customizer-models-js', $this->_extension_url . 'new/header-models.js');
                  mn_enqueue_script('redux-extension-customizer-slimscroll-js', $this->_extension_url . 'new/jquery.slimscroll.js');
                  mn_enqueue_script('redux-extension-customizer-droppable-js', $this->_extension_url . 'new/jquery.ui.droppable.min.js');
                  mn_enqueue_script('redux-extension-customizer-editor-js', $this->_extension_url . 'new/media-editor.min.js');
                  mn_enqueue_script('redux-extension-customizer-new-js', $this->_extension_url . 'new/new-customizer.js');
                  mn_enqueue_script('redux-extension-customizer-previewing-js', $this->_extension_url . 'new/previewing.js');
                  mn_enqueue_script('redux-extension-customizer-theme-js', $this->_extension_url . 'new/theme-customizer.js');
                 */
            }

            // All sections, settings, and controls will be added here
            public function _register_customizer_controls( $mn_customize ) {
                $order    = array(
                    'heading' => - 500,
                    'option'  => - 500,
                );
                ...
                foreach ( $this->parent->sections as $key => $section ) {
                    ...
                    $mn_customize->add_section( $section['id'], array(
                        'title'       => $section['title'],
                    ...
                    foreach ( $section['fields'] as $skey => $option ) {
                        ...
                        if ( $option['type'] != "heading" || ! empty( $option['type'] ) ) {
                            $mn_customize->add_setting( $option['id'], $customSetting );
                        }
                        ...
                        switch ( $option['type'] ) {
                            ...
                            case 'text':
                                ...
                                $mn_customize->add_control( $option['id'], array(
                                    'label'    => $option['title'],
                                    'section'  => $section['id'],
                                    'settings' => $option['id'],
                            ...
                            case 'media':
                                continue;
                                $mn_customize->add_control( new mn_Customize_Image_Control( $mn_customize, $option['id'], array(
                                    'label'    => $option['title'],
                                    'section'  => $section['id'],
                                    'settings' => $option['id'],
                                    'priority' => $option['priority']
                            ...
                            case 'color':
                                $mn_customize->add_control( new mn_Customize_Color_Control( $mn_customize, $option['id'], array(
                                    'label'    => $option['title'],
                                    'section'  => $section['id'],
                                    'settings' => $option['id'],
                                    'priority' => $option['priority']
                            ...
                            case 'switch':
                                continue;
                                $mn_customize->add_control( new Redux_customizer_switch( $mn_customize, $option['id'], array(
                                    'label'          => $option['title'],
                                    'section'        => $section['id'],
                                    'settings'       => $option['id'],
                                    'field'          => $option,
            ...
            public function customizer_save_after( $mn_customize ) {
                //if( isset( $_POST['customized'] ) ) {
                $options  = json_decode( stripslashes_deep( $_POST['customized'] ), true );
                $compiler = false;
                $changed  = false;
            ...
            public function _enqueue() {
                ...
                //mn_enqueue_script('redux-extension-customizer-js', $this->_extension_url . 'assets/js/customizer.js');
                // Get styles
                //mn_enqueue_style('redux-extension-customizer-css', $this->_extension_url . 'assets/css/customizer.css');
