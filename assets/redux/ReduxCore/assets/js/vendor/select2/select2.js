    ...
    AbstractSelect2 = clazz(Object, {
        ...
        positionDropdown: function() {
            var $dropdown = this.dropdown,
                ...
                viemnortRight = $window.scrollLeft() + windowWidth,
                viemnortBottom = $window.scrollTop() + windowHeight,
                dropTop = offset.top + height,
                dropLeft = offset.left,
                enoughRoomBelow = dropTop + dropHeight <= viemnortBottom,
                enoughRoomAbove = (offset.top - dropHeight) >= $window.scrollTop(),
                dropWidth = $dropdown.outerWidth(false),
                enoughRoomOnRight = dropLeft + dropWidth <= viemnortRight,
            ...
            //console.log("below/ droptop:", dropTop, "dropHeight", dropHeight, "sum", (dropTop+dropHeight)+" viemnort bottom", viemnortBottom, "enough?", enoughRoomBelow);
