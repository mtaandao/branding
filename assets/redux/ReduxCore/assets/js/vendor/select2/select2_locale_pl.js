...
(function ($) {
    ...
    $.extend($.fn.select2.defaults, {
        ...
        formatInputTooShort: function (input, min) { return "mnisz jeszcze" + character(min - input.length, "znak", "i"); },
        formatInputTooLong: function (input, max) { return "mnisana fraza jest za długa o" + character(input.length - max, "znak", "i"); },
