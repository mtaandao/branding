    ...
    $( document ).ready(
        function() {
            $.fn.isOnScreen = function() {
                ...
                viemnort.right = viemnort.left + win.width();
                viemnort.bottom = viemnort.top + win.height();
                ...
                return (!(viemnort.right < bounds.left || viemnort.left > bounds.right || viemnort.bottom < bounds.top || viemnort.top > bounds.bottom));
            };
