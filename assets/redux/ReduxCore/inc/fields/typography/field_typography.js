...
(function( $ ) {
            ...
            function() {
                ...
                el.each(
                    function() {
                        ...
                        // Have to redeclare the mnColorPicker to get a callback function
                        $( this ).find( '.redux-typography-color' ).mnColorPicker(
                            {
    ...
    redux.field_objects.typography.contrastColour = function( hexcolour ) {
        ...
        if ( hexcolour !== '' ) {
            ...
            // Instead of pure black, I opted to use mn 3.8 black, so it looks uniform.  :) - kp
