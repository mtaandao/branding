/**
 * Redux Background
 * Dependencies        : jquery, mn media uploader
 * Feature added by    : Dovy Paukstys
 * Date                : 07 Jan 2014
 */

/*global redux_change, mn, redux*/
...
(function( $ ) {
    ...
    redux.field_objects.background.init = function( selector ) {
        ...
        $( selector ).each(
            function() {
                ...
                el.find( '.redux-color' ).mnColorPicker({
                ...
                el.find( '.redux-color' ).on(
                    'blur', function() {
                        ...
                        if ( value === "transparent" ) {
                            $( this ).parent().parent().find( '.mn-color-result' ).css(
                ...
                el.find( '.color-transparency' ).on(
                    'click', function() {
                        if ( $( this ).is( ":checked" ) ) {
                            ...
                            el.find( '#' + $( this ).data( 'id' ) ).parent().parent().find( '.mn-color-result' ).css(
                                'background-color', 'transparent'
                            );
                        } else {
    ...
    // Add a file via the mn.media function
    ...
    redux.field_objects.background.removeImage = function( selector ) {
        ...
        // This means the user doesn't have the Mtaandao 3.5 Media Library Support
