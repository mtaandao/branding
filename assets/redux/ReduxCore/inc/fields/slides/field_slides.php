    ...
    class ReduxFramework_slides {
        ...
        public function render () {
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
                    ...
                    $slide = mn_parse_args ( $slide, $defaults );

                    if ( empty ( $slide[ 'thumb' ] ) && !empty ( $slide[ 'attachment_id' ] ) ) {
                        $img = mn_get_attachment_image_src ( $slide[ 'attachment_id' ], 'full' );
                        $slide[ 'image' ] = $img[ 0 ];
                        $slide[ 'width' ] = $img[ 1 ];
                        $slide[ 'height' ] = $img[ 2 ];
                    }
        ...
        public function enqueue () {
            ...
            mn_enqueue_script (
                ...
                array( 'jquery', 'jquery-ui-core', 'jquery-ui-accordion', 'mn-color-picker', 'redux-field-media-js' ), 
                time (), 
                true
            );
