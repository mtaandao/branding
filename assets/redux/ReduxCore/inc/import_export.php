    ...
    if ( ! class_exists( 'Redux_import_export' ) ) {
        ...
        class Redux_import_export {
            ...
            public function __construct( $parent ) {
                ...
                add_action( "mn_ajax_redux_link_options", array( $this, "link_options" ) );
                add_action( "mn_ajax_nopriv_redux_link_options", array( $this, "link_options" ) );

                add_action( "mn_ajax_redux_download_options", array( $this, "download_options" ) );
                add_action( "mn_ajax_nopriv_redux_download_options", array( $this, "download_options" ) );
            }
            ...
            function link_options() {
                if ( ! isset( $_GET['secret'] ) || $_GET['secret'] != md5( md5( AUTH_KEY . SECURE_AUTH_KEY ) . '-' . $this->parent->args['opt_name'] ) ) {
                    mn_die( 'Invalid Secret for options use' );
                    exit;
                }
