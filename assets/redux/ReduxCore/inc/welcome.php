    ...
    class Redux_Welcome {
        ...
        public function parse_readme() {
            ...
            if ( ! $file ) {
                ...
                $readme = mn_remote_retrieve_body( mn_remote_get( $file ) );
        ...
        public function contributors() {
            ...
            $contributor_list = '<ul class="mn-people-group">';

            foreach ( $contributors as $contributor ) {
                $contributor_list .= '<li class="mn-person">';
        ...
        public function get_contributors() {
            ...
            $response = mn_remote_get( 'https://api.github.com/repos/ReduxFramework/redux-framework/contributors', array( 'sslverify' => false ) );

            if ( is_mn_error( $response ) || 200 != mn_remote_retrieve_response_code( $response ) ) {
                return array();
            }

            $contributors = json_decode( mn_remote_retrieve_body( $response ) );
