        ...
        class Redux_Filesystem {
            ...
            public function ftp_form() {
                if ( isset( $this->ftp_form ) && ! empty( $this->ftp_form ) ) {
                    ...
                    echo ' <code>' . Redux_Helpers::cleanFilePath( trailingslashit( MAIN_DIR ) ) . '/uploads/</code> ';
            ...
            public function do_action( $action, $file = '', $params = '' ) {
                ...
                if ( $action == 'mkdir' && ! isset( $this->filesystem->killswitch ) ) {
                    ...
                    $res = $mn_filesystem->copy( $file, $destination, $overwrite, $chmod );
                    if ( ! $res ) {
                    ...
                    $res = $mn_filesystem->put_contents( $file, $content, $chmod );
                    if ( ! $res ) {
                    ...
                    $res = $mn_filesystem->get_contents( $file );
                    if ( ! $res ) {
