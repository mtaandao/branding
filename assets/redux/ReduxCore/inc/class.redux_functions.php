...
// Don't duplicate me!
    if ( ! class_exists( 'Redux_Functions' ) ) {
        ...
        class Redux_Functions {
            ...
            /**
             * initmnFilesystem - Initialized the Wordpress filesystem, if it already isn't.
             *
             * @since       3.2.3
             * @access      public
             * @return      void
             */
            public static function initmnFilesystem() {
