    ...
    if ( ! class_exists( 'ReduxFrameworkPlugin' ) ) {
        ...
        class ReduxFrameworkPlugin {
            ...
            private function hooks() {
                add_action( 'mn_loaded', array( $this, 'options_toggle_check' ) );

                // Activate plugin when new blog is added
                add_action( 'mnmu_new_blog', array( $this, 'activate_new_site' ) );
            ...
            public function load_first() {
                $path = str_replace( mn_PLUGIN_DIR . '/', '', __FILE__ );
            ...
            /**
             * Fired when a new mnMU site is activated
             *
             * @access      public
             * @since       3.0.0
             *
            ...
            private static function get_blog_ids() {
                ...
                // Get an array of IDs
                $sql = "SELECT blog_id FROM $mndb->blogs
                    WHERE archived = '0' AND spam = '0'
                    AND deleted = '0'";

                return $mndb->get_col( $sql );
            }

            /**
             * Fired for each mnMS blog on plugin activation
             *
             * @access      private
             * @since       3.0.0
             * @return      void
